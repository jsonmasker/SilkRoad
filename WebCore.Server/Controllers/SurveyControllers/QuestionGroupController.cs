...
namespace WebCore.Server.Controllers.SurveyControllers
{
    ...
    {
        private readonly IQuestionGroupHelper _helper;
        private readonly IActionLoggingService _actionLog;
        private readonly IStringLocalizer<SharedResource> _localizer;
        public QuestionGroupController(IQuestionGroupHelper helper,
        ...
        //    if (data == null)
        //        return Failed(EStatusCodes.NotFound, _localizer["notFound"]);
        //    return Succeeded<QuestionGroupDTO>(data, _localizer["dataFetchedSuccessfully"]);
        //}

        [HttpPost("create")]
        public async Task<IActionResult> Create([FromBody] QuestionGroupDTO model)
        {
        ...
        [HttpPut("update")]
        public async Task<IActionResult> Update([FromBody] QuestionGroupDTO model)
        {
            if (model == null || !ModelState.IsValid)
                return Failed(EStatusCodes.BadRequest, _localizer["invalidData"]);
